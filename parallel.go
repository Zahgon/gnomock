...
func InParallel() *Parallel { _ = "STUB: not implemented"; return nil }
...
func (b *Parallel) Start(p Preset, opts ...Option) *Parallel { _ = "STUB: not implemented"; return nil }
...
func (b *Parallel) Go() ([]*Container, error) { _ = "STUB: not implemented"; return nil, nil }
